...
public class PedidoProduto implements Serializable {
   ...
   @Id
    ...
    private double totalPedidoProduto;

    public double getTotalPedidoProduto() {
        return totalPedidoProduto;
    }

    public void setTotalPedidoProduto(double totalPedidoProduto) {
        this.totalPedidoProduto = totalPedidoProduto;
    }
