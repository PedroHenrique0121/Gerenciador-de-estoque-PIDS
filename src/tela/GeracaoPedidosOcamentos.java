 ...
 * @author pedro
 */
public class GeracaoPedidosOcamentos extends javax.swing.JFrame {
    ...
    private static GeracaoPedidosOcamentos geracao;

    public static GeracaoPedidosOcamentos getInstancia() {
        if (geracao == null) {
            geracao = new GeracaoPedidosOcamentos();
        }
        return geracao;
    }

    public GeracaoPedidosOcamentos() {
        initComponents();
        ...
        jtfCodigoUsuario.setText(VerificacaoLoginUsuario.userStatic.getId()+"");
        jtfNomeVendedor.setText(VerificacaoLoginUsuario.userStatic.getNome());
        JtableVenda1.setRowHeight(29);
        jtableProduto.setRowHeight(29);
    }
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addComponent(jSrcolpaneInterno2, javax.swing.GroupLayout.DEFAULT_SIZE, 842, Short.MAX_VALUE)
        );
                ...
                .addGroup(clienteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, clienteLayout.createSequentialGroup()
                        ...
                        .addGroup(clienteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel5, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 858, Short.MAX_VALUE)
        ...
        jScrollPane8.setForeground(new java.awt.Color(0, 0, 204));
        jScrollPane8.setFont(new java.awt.Font("Yu Gothic UI Semibold", 0, 18)); // NOI18N
        ...
        JtableVenda1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "", "DESCRITIVO", "QTD", "VALOR UNITARIO", "VALOR TOTAL"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        if (JtableVenda1.getColumnModel().getColumnCount() > 0) {
            ...
            JtableVenda1.getColumnModel().getColumn(1).setPreferredWidth(250);
            JtableVenda1.getColumnModel().getColumn(2).setPreferredWidth(40);
        }
        ...
        jbtPesquisaProduto.setFont(new java.awt.Font("Yu Gothic UI Semibold", 1, 18)); // NOI18N
        jbtPesquisaProduto.setText("...");
        ...
        jtfDescritivo.setEditable(false);
        jtfDescritivo.setFont(new java.awt.Font("Yu Gothic UI Semibold", 0, 18)); // NOI18N

        jtfQuantidade.setFont(new java.awt.Font("Yu Gothic UI Semibold", 0, 18)); // NOI18N
        ...
        geraçaoLayout.setHorizontalGroup(
            ...
            .addGroup(geraçaoLayout.createSequentialGroup()
                ...
                .addGroup(geraçaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(geraçaoLayout.createSequentialGroup()
                        .addGroup(geraçaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(geraçaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jtfDescritivo, javax.swing.GroupLayout.PREFERRED_SIZE, 610, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addComponent(jScrollPane8, javax.swing.GroupLayout.PREFERRED_SIZE, 816, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(80, 80, 80))
        );
        ...
        jScrollPane1.setFont(new java.awt.Font("Yu Gothic UI Semibold", 0, 18)); // NOI18N
        ...
        jtableProduto.setFont(new java.awt.Font("Yu Gothic UI Semibold", 1, 18)); // NOI18N
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addComponent(jSrcolpaneInterno, javax.swing.GroupLayout.PREFERRED_SIZE, 280, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
    ...
    private void jtfCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtfCodigoActionPerformed
        ...
        try {
            ...
            produto = em.find(Produto.class, Integer.parseInt(jtfCodigo.getText()));
    ...
    private void jbtadicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtadicionarActionPerformed
        ...
        if (jtfCodigo.getText().equals("") || jtfQuantidade.getText().equals("") || jtfDescritivo.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Preencha os campos adequadamente!");
        } else {
            int q = Integer.parseInt(jtfQuantidade.getText());
            try {

                if (q <= 0) {
                    JOptionPane.showMessageDialog(null, "Quantidade é invalida!");
                    ...
                    dtm.addRow(new Object[]{
                        ...
                        (produto.getPrecoVendaProduto()+"").format("%.2f",produto.getPrecoVendaProduto() ),
                        (q * produto.getPrecoVendaProduto() + "").format("%.2f", q * produto.getPrecoVendaProduto())
                    });
                }
            } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(null, "Quantidade é invalida!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GeracaoPedidosOcamentos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GeracaoPedidosOcamentos().setVisible(true);
            }
        });
    }
    ...
    public void finalizarPedido() {
        ...
        for (int i = 0; i < JtableVenda1.getRowCount(); i++) {
            ...
            pro.setPrecoVendaProduto((Double.parseDouble(JtableVenda1.getValueAt(i, 3).toString().replaceAll(",", "."))));
    ...
    public void criarPedido(List<PedidoProduto> lista) {
        ...
        try {
            ...
            Logger.getLogger(GeracaoPedidosOcamentos.class.getName()).log(Level.SEVERE, null, ex);
        }
