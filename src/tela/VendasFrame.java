...
public class VendasFrame extends javax.swing.JFrame {
    ...
    private static double descontoStatico =0;
    ...
    public VendasFrame() throws SQLException, ClassNotFoundException {
        ...
        iconEmp.setImage(iconEmp.getImage().getScaledInstance(273, 170, 1));
...
//        lblImagemPagamento.setIcon(imagemp);
    ...
    private void initComponents() {
        ...
        jtfDesconto.setFont(new java.awt.Font("Yu Gothic UI Semibold", 1, 18)); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .add(jPanel3Layout.createSequentialGroup()
                ...
                .add(jtfDesconto, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 291, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .add(jPanel3Layout.createSequentialGroup()
                ...
                .add(jPanel3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(jtfDesconto, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(jLabel7))
        ...
        jlbDesconto.setFont(new java.awt.Font("Yu Gothic UI Semibold", 0, 18)); // NOI18N
        jlbDesconto.setForeground(new java.awt.Color(0, 0, 255));
                            ...
                            .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel1Layout.createSequentialGroup()
                                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                                    ...
                                    .add(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .add(jlbDesconto, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 168, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
                                .add(50, 50, 50))
                            .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel1Layout.createSequentialGroup()
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel1Layout.createSequentialGroup()
                                        .add(lblImagemLogo, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 273, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                        .add(61, 61, 61))
                                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel1Layout.createSequentialGroup()
...
//        });
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        ...
        jtfDesconto.grabFocus();
    }//GEN-LAST:event_jMenuItem2ActionPerformed

    private void jtfDescontoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtfDescontoKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            try {
                double valorDesconto = Double.parseDouble(jtfDesconto.getText().replaceAll(",", "."));
                double calculo = Double.parseDouble(jtfValorTotal1.getText().replaceAll(",", ".")) - valorDesconto;
                jtfValorTotal1.setText(String.valueOf(calculo).format("%.2f", calculo));
                descontoStatico = valorDesconto;
            } catch (NullPointerException e) {
                JOptionPane.showMessageDialog(null, "Campo Desconto noão pode ser vazio!");

            } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(null, "Campo Desconto noão pode ser literal!");
            }
            CardLayout card = (CardLayout) root.getLayout();
            card.show(root, "inicio");
            jlbDesconto.setText("Desconto Aplicado!");
        }
